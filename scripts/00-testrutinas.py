...
print("back to degree one last time:",cf.ddmmss_compact_to_degree(cf.degree_to_ddmmss_compact(cf.ddmmss_compact_to_degree(x))))
print("back to compact one last time:",cf.degree_to_ddmmss_compact(cf.ddmmss_compact_to_degree(cf.degree_to_ddmmss_compact(cf.ddmmss_compact_to_degree(x)))))
